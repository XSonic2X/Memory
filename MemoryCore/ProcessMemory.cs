...
namespace MemoryCore
{
    ...
    public class ProcessMemory
    {
        ...
        /// <returns></returns>
        public IntPtr FinalAddress32(IntPtr BaseAddress, int[] BiasAddress)
        {
        ...
        public IntPtr FinalAddress32(int[] BiasAddress) => FinalAddress32(baseAddress, BiasAddress);
        public IntPtr FinalAddress64(IntPtr BaseAddress, int[] BiasAddress)
        {
            for (int i = 0; i < BiasAddress.Count() - 1; i++)
            {
                BaseAddress = (IntPtr)ReadInt64(IntPtr.Add(BaseAddress, BiasAddress[i]));
